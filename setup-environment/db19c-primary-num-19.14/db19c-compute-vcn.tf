...
resource "oci_core_app_catalog_subscription" "generated_oci_core_app_catalog_subscription" {
  ...
  listing_resource_version = "Oracle_Database_19.14.0.0.220118_-_OL7U9"
...
resource "oci_core_instance" "ssworkshop_instance" {
  ...
  source_details {
    source_type = "image"
    source_id   = "ocid1.image.oc1..aaaaaaaabisx6cnwmu4fjgwh4gxwcnvppdttfh5ltqfihnpjerxzzfs7fttq"
