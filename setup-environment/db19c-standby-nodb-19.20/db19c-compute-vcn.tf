...
resource "oci_core_app_catalog_subscription" "generated_oci_core_app_catalog_subscription" {
	...
	listing_resource_version = "Oracle_Database_19.20.0.0.230718_-_OL7U9"
...
resource "oci_core_instance" "ssworkshop_instance" {
 // count               = "${var.num_instances}"
  ...
  source_details {
    source_type = "image"
    source_id   = "ocid1.image.oc1..aaaaaaaahgxknotlyp6ait2efa7xmas3w5azhgc52dowpkzo4hy7jwqqqx4q"
